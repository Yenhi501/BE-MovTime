...
export class MovieService implements IMovieService {
	...
	searchMovies(searchConditions: any, page: number, pageSize: number): Promise<{ movies: Movie[]; totalCount: number; }> {
	...
	addGenresForMovie(req: express.Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>): Promise<MovieGenre[]> {
		throw new Error('Method not implemented.');
	}
	deleteGenresOfMovie(req: express.Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>): Promise<number> {
		throw new Error('Method not implemented.');
	}
	clearCacheCloudFrontMovie(req: express.Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>): Promise<void> {
		throw new Error('Method not implemented.');
	}
